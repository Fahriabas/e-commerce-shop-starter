  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-y-3 py-4 mt-4">
        ...
        <Link
          to={"/"}
          className="bg-gray-200 flex p-4 justify-center items-center text-primary w-full fot-medium"
        >
          View Cart
        </Link>
        <Link className="bg-primary flex p-4 justify-center items-center text-white w-full fot-medium">
          Checkout
        </Link>
      </div>
    </div>
